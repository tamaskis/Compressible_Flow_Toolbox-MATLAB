...
%           <td><TT>Q_spec</TT></td>
%           <td>specifies output quantity (see list below)</td>
...
%           <td><TT>Q_out</TT></td>
%           <td>output quantity (specified by <TT>Q_spec</TT>)</td>
%           <td style="text-align:center">N×1 or 1×N<BR>double</td>
%       </tr>
%   </table>
% </html>
%
% _*NOTE:*_ |M1| can be input as a scalar or a vector. If |M1| is input as
% a vector, then "N" is the length of this vector. If |M1| is input as a
% scalar, then N = 1.
%
...
rho2_rho_1 = normal_shock(M1,gamma,'rho2/rho1')
%%
