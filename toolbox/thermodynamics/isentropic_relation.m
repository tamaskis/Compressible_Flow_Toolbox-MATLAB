%==========================================================================
%
% isentropic_relation  Converts any ratio to any other ratio in an 
% isentropic process involving a calorically perfect gas.
%
%   Q_out = isentropic_relation(spec_in,Q_in,spec_out)
%   Q_out = isentropic_relation(spec_in,Q_in,spec_out,gamma)
%
...
%
%==========================================================================
function Q_out = isentropic_relation(spec_in,Q_in,spec_out,gamma)
